  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="!text-[1.6rem]">Course Purchases</h1>
        ...
        {payments !== null && totalRevenue > 0 && (
          <Card className="!p-4 !py-3 border-[var(--st-on-track)]" style={{ background: "var(--st-on-track-soft)" }}>
            <p className="text-[0.72rem] font-bold uppercase tracking-widest text-[var(--st-on-track-ink)]">
              Total Revenue
            </p>
            <p className="text-[1.8rem] font-extrabold leading-none text-[var(--st-on-track-ink)]">
      ...
      {payments !== null && payments.length === 0 && (
        <Card className="!p-8 text-center">
          <p className="text-[0.92rem] text-ink-3">No purchases yet.</p>
        </Card>
      )}
            ...
            <Card key={p.id} className="!p-5">
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  <p className="text-[1.25rem] font-extrabold text-ink tnum">
