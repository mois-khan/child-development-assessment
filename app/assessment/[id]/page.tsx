...
export default function AssessmentPage({
  ...
  /** The question bank has to be in memory before the first question renders
   *  — there is no shipped wording to show in the meantime, so a half-loaded
   *  bank means a spinner, and a failed one means the same blocking error as
   *  a failed assessment load. */
