...
/** WhatsApp's own speech-bubble-and-handset mark, not a generic chat bubble. */
export function IconWhatsApp(p: IconProps) {
  return (
    <Svg {...p}>
      <path d="M12 2.5c-5.25 0-9.5 4.25-9.5 9.5 0 1.77.49 3.43 1.33 4.85L2.5 21.5l4.8-1.27A9.45 9.45 0 0 0 12 21.5c5.25 0 9.5-4.25 9.5-9.5s-4.25-9.5-9.5-9.5z" />
      <path d="M8.6 8.35c.22-.5.4-.55.68-.55h.55c.18 0 .37.02.53.4.2.46.68 1.66.74 1.78.06.13.1.28.02.45-.08.16-.13.27-.26.42-.13.15-.27.33-.38.44-.13.13-.26.27-.11.53.51.85 1.15 1.44 1.87 1.9.3.19.6.36.83.14.24-.22.5-.58.68-.78.17-.2.34-.16.56-.1.23.08 1.47.69 1.72.82.25.13.42.19.48.3.06.11.06.62-.15 1.22-.21.6-1.2 1.08-1.68 1.15-.43.06-.97.09-1.57-.1a13.6 13.6 0 0 1-1.15-.43c-1.95-.85-3.28-2.68-3.5-3-.22-.31-1.16-1.62-1.16-3.09 0-1.47.75-2.18 1-2.49z" />
    </Svg>
  );
}
